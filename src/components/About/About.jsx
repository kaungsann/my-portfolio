...
export default function About() {
  return (
    <>
      <div
        className="mx-auto lg:w-10/12 md:w-full md:p-4   lg:mt-14  aboutcontainer"
        id="about"
      >
        ...
        <div className="flex justify-center aboutwrap  lg:mt-8 pt-5 md:flex-wrap md:w-full lg:flex-nowrap xl:flex-nowrap ">
          <div className="textandicons lg:flex-nowrap xl:flex-nowrap flex justify-evenly bg-slate-100 shadow-sm  lg:pt-4 md:pt-4 lg:w-10/12 lg:mr-10 lg:ml-30 md:w-full md:flex-wrap">
            <Slide left>
              <div className="ksimg mt-4">
                <img src={ksh} className=" ksimage shadow-xl rounded-lg" />
              </div>
            </Slide>
            ...
            <Slide bottom>
              <div className="textbox  mx-10 flex flex-col justify-start items:start md:w-8/12 lg:w-2/5">
                ...
                with new technologies and trends in web developme */}
                  As a botany student in my final year at Dagon University, I
            ...
            <Slide right>
              <div className="progressbar	lg:w-2/5 text-lg lg:ml-3 mb-6 md:w-7/12 md:mt-20 lg:mt-0  md:p-4">
                <div className=" flex flex-col md:my-6 lg:my-1 xl:my-2 bars ">
                  ...
                  <div className=" bg-slate-300 lg:w-90 h-2 md:mt-2 ml-4  md:w-10/12 lg:w-10/12 ">
                    <div className="progress w-4/5	 md:w-9/12 lg:w-10/12 fill-red-800 html "></div>
                  </div>
                </div>
                <div className="lg:py-0 md:my-6 bars">
                  ...
                  <div className=" bg-slate-300 lg:w-90 h-2 mt-2 ml-4 md:w-10/12">
                    <div className="progress w-4/5	 fill-red-800 md:w-8/12 lg:w-10/12"></div>
                  </div>
                </div>
                <div className="lg:py-0 md:my-6 bars">
                  <div className="md:text-2xl md:my-2 lg:my-0 lg:text-xl bartext">
                  ...
                  <div className=" bg-slate-300 lg:w-90 h-2 mt-2 ml-4 md:w-10/12">
                    <div className="progress w-8/12 fill-red-800 md:w-8/12 lg:w-8/12"></div>
                  </div>
                </div>
                <div className="lg:py-0 md:my-6 bars">
                  <div className="md:text-2xl md:my-2 lg:my-0 lg:text-xl bartext">
                  ...
                  <div className=" bg-slate-300 lg:w-90 h-2 mt-2 ml-4 md:w-10/12">
                    <div className="progress  w-8/12 fill-red-800 md:w-6/12 lg:w-8/12"></div>
                  </div>
                </div>
                <div className="lg:py-0 md:my-6 bars">
                  <div className="md:text-2xl md:my-2 lg:my-0 lg:text-xl bartext">
                  ...
                  <div className=" bg-slate-300 lg:w-90 h-2 mt-2 ml-4 md:w-10/12">
                    <div className="progress w-7/12	 fill-red-800 md:w-7/12"></div>
                  </div>
                </div>
                <div className="lg:py-0 md:my-6 bars">
