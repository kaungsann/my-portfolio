    ...
    <>
      <div className="mx-auto w-8/12 mt-6 ">
        ...
        <div className="flex justify-center  lg:mt-8 pt-5  ">
          <div className="mb-20 lg:w-40 h-60 xl:ml-15 md:ml-10 w-96 shadow-xl  lg:mr-10 ">
            <img src={icons} className=" pb-10" />
          </div>
          <div className="flex justify-evenly bg-slate-100 shadow-xl rounded-xl pt-4 lg:w-8/12 lg:mr-10 lg:ml-30">
            <div className="w-1/3 mx-10 flex flex-col justify-start items:start">
              ...
              <button className="dwbtn w-32 p-2 rounded-lg shadow-xl mt-6 hover:bg-red-400  focus:outline-none ">
                Download CV
              </button>
            </div>
