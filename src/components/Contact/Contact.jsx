...
function Contact() {
  return (
    <>
      <div className=" w-8/12		mx-auto lg:mt-14" id="contact">
        ...
        <div className="flex justify-center mt-3 p-3 w-full sm:flex-wrap ">
          ...
          <div className="flex flex-col p-5 justify-center w-3/5">
            <input
              ...
              className="p-5 w-9/12	  border-slate-400 border-2 text-2xl rounded focus:outline-none focus:ring  focus:ring-red-500"
            />
            <input
              type="text"
              placeholder="Insert your Email"
              className="p-5 w-9/12 mt-6  border-slate-400 border-2 text-2xl  rounded focus:outline-none focus:ring  focus:ring-red-500"
            />
            <textarea
              className="p-5 w-9/12 border-slate-400 mt-6  rounded border-2  text-2xl focus:outline-none focus:ring  focus:ring-red-500"
